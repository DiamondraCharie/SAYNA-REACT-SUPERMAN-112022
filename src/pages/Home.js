   ...
   <div className='container'>
      <section className='superman-cinema'>
         ...
         <div className='s-personnage'>
            ...
            <img src={img3} alt=''style={{ marginRight: '105px' }}/>
            <img src={img4} alt=''/>
         </div>
      </section>
      <section className='superman-nemesis'>
         <div className='s-content'>
           <h2>NÉMÉSIS</h2>
      ...
      <section className='superman-allies'>
         <div className='s-content'>
           <h2>ALLIÉS</h2>
        ...
        <div className="form">
           <h2>PRENONS CONTACT</h2>
              <form action="form" method="get">
                 <label className="title" for="email">ADRESSE EMAIL</label>
                 <input type="email" className="email" name="email" placeholder="Adresse email"/>
                 <label className="title" for="newsletter">NEWSLETTER</label><br/>
                 <label className="text" for="case">En cochant cette case vous acceptez de recevoir l’actualité concernant les <br/> aventures de
                  Superman :</label>
                 <input type="checkbox"/> 
                 <div className="frequence">
                  ...
                  <div className="btn-group">
                    <input className="bouton" type="radio" name="film"/>
                    <label for="film">Des Films</label>
                    <input className="bouton" type="radio" name="comics"/>
                    <label for="comics">Des Comics </label>
                    <input className="bouton" type="radio" name="tout"/>
                    <label for="tout">De tout</label>
                  </div>
                  <label className="title" for="email">MESSAGE</label>
                  <textarea name="commentaire" className="commentaire" cols="30" placeholder="Laissez un commentaire pour la communauté"></textarea>
                  <input className="my-bouton" type="submit" value="CONFIRMER"/>
              </form>
          </div>
        </section>   
         <div class="citation-carte">
               <img className='right' src={iconguillemets1} alt=''/>  
               <p>- Que représente le S ?</p>
               <p>- Ce n’est pas un S. Sur ma planète cela signifie espoir.</p>
               <span>Man Of Steel, Lois Lane et Clark Kent.</span>
               <img className='left' src={iconguillemets2} alt=''/>  
         </div>
    </main>
  )
}
